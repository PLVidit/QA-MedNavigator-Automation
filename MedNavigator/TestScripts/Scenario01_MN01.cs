...
/// </summary>
////Test Case Description - User is able to create campaign for Physician Profile for n number of profiles (Payment through Paypal/Stripe payment)/////
/// </summary>
