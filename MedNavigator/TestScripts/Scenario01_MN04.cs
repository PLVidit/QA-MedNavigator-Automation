...
/// </summary>
////Test Case Description -User is able to create camapaign for Search Residents & Fellows Profile for 3 number of profiles (Payment through Paypal/Stripe payment)    /////
/// </summary>

namespace MedNavigator.TestScripts
{
    public class Scenario01_MN04
    {
        ...
        public void CampaignCreation()
        {
            ...
            medNavigatorPage.ClickSearchButton_ResidentsAndFollows();
