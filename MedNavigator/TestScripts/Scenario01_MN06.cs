...
{
    /// </summary>
    ////Test Case Description - User selects the record through Detail Section and send the camapign /////
    /// </summary>

    namespace MedNavigator.TestScripts
    {
        public class Scenario01_MN06
        {
            ...
            public void CampaignCreation()
            {
                ...
                medNavigatorPage.ClickDetails();            



                PhysicianDetailsPage physicianDetail = new PhysicianDetailsPage(webDriver);
                physicianDetail.selectCandidate();
                physicianDetail.CreateCampaign();
