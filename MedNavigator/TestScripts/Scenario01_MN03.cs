...
/// </summary>
////Test Case Description - User is able to create camapaign for GME Programs Profile for 3 number of profiles (Payment through Paypal/Stripe payment)    /////
/// </summary>


namespace MedNavigator.TestScripts
{
    public class Scenario01_MN03
    {
        ...
        public void CampaignCreation()
        {
            ...
            medNavigatorPage.ClickSearchButton_GME();
