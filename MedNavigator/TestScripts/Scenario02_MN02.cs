...
/// </summary>
////Test Case Description - User selects  the by default echo campaign days ( defualt days e.g.-3 days)/////
/// </summary>
...
namespace MedNavigator.TestScripts
{
    public class Scenario02_MN02
    {
        ...
        public void EchoCampaign_04()
        {
            ...
            completeRequestPage.SelectEchoCampaignDays_3();
